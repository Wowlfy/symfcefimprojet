 ...
 */
final class Version20220607115859 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE skill_profile (id INT AUTO_INCREMENT NOT NULL, sp_applicant_id INT DEFAULT NULL, sp_employee_id INT DEFAULT NULL, sp_description VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_9BA23426E8A1B45D (sp_applicant_id), UNIQUE INDEX UNIQ_9BA23426542A1610 (sp_employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission DROP FOREIGN KEY FK_9067F23C6C07F179');
